 ...
 <div class="photo_bg">
  ...
  <div class="photo_leftcol">
   <div class="ratingbg">
	...
	[owner]<div class="rateforowne">Оценок: &nbsp;<a class="cursor_pointer" onClick="Photo.allrating({id})">{rate-all}</a>&nbsp;&nbsp;&nbsp; Пятерок с плюсом: &nbsp;<a class="cursor_pointer" onClick="Photo.allrating({id})">{rate-max}</a>&nbsp;&nbsp;&nbsp; Общий балл: &nbsp;<a class="cursor_pointer" onClick="Photo.allrating({id})">{rate}</a></div>[/owner]
   </div>  
  ...
  <div class="photo_rightcol">
   ...
   [owner]<a href="/" onClick="photoeditor.start('{photo}', '{id}', '{height}'); return false"><img class="icon edit_ic" src="{theme}/images/spacer.gif" alt="" /><div>Корректировать</div></a>	
   ...
   <a onClick="Report.Box('photo', '{id}')"><img class="icon compla_ic" src="{theme}/images/spacer.gif" alt="" /><div>Пожаловаться на фотографию</div></a>
