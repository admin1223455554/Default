...
[owner]
<a href="/editmypage" onClick="Page.Go(this.href); return false;"><img class="icon edit_ic" src="{theme}/images/spacer.gif" alt="" /><div>Редактировать страницу</div></a>
...
<a href="/" onClick="Profile.miniature(); return false;"><img class="icon editphoto_miniature" src="{theme}/images/spacer.gif" alt="" /><div>Изменить миниатюру</div></a>
...
[blacklist]<div class="leftcbor">
 [owner][happy-friends]<div id="happyBLockSess"><div class="albtitle box_shadow" style="margin-top:5px">Дни рожденья друзей <span></span><div class="profile_happy_hide"><img src="{theme}/images/hide_lef.gif" onMouseOver="myhtml.title('1', 'Скрыть', 'happy_block_')" id="happy_block_1" onClick="HappyFr.HideSess(); return false" /></div></div>
 ...
 [/happy-friends][/owner]
 [online-friends]<a href="/friends/online/{user-id}" onClick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle box_shadow">Друзья в нете: <span>{online-friends-num}</span><div class="icon_friend" onMouseOver="myhtml.title('5', '<b>Показать всех друзей</b>', 'fine_tooltip_')" id="fine_tooltip_5"></div></div></a>
 <div class="newmesnobg box_shadow_left" style="padding:0px;padding-top:10px;">{online-friends}<div class="clear"></div>
 </div>[/online-friends]
 [subscriptions]<a href="/" onClick="subscriptions.all({user-id}, '', {subscriptions-num}); return false" style="text-decoration:none"><div class="albtitle box_shadow">Интересные люди <span>{subscriptions-num}</span><div class="icon_friend" onMouseOver="myhtml.title('6', '<b>Показать всех людей</b>', 'fine_tooltip_')" id="fine_tooltip_6"></div></div></a>
 <div class="newmesnobg box_shadow_left" style="padding-right:0px;padding-bottom:1px;">{subscriptions}<div class="clear"></div>
 </div>[/subscriptions]
  [gifts]<a href="/gifts{user-id}" onClick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle box_shadow">{gifts-text}<div class="icon_gift" onMouseOver="myhtml.title('7', '<b>Показать все подарки</b>', 'fine_tooltip_')" id="fine_tooltip_7"></div></div><div class="newmesnobg box_shadow_left"><center>{gifts}</center></div><div class="clear"></div></a>[/gifts]
 [groups]<div class="albtitle cursor_pointer box_shadow" onClick="groups.all_groups_user('{user-id}')">Интересные страницы <span id="groups_num">{groups-num}</span></div>
 <div class="newmesnobg box_shadow_left" style="padding-right:0px;padding-bottom:1px;">{groups}<div class="clear"></div>
 </div>[/groups]
 [videos]<a href="/videos/{user-id}" onClick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle box_shadow">Видеозаписи <span>{videos-num}</span><div class="icon_video" onMouseOver="myhtml.title('9', '<b>Показать все видео</b>', 'fine_tooltip_')" id="fine_tooltip_9"></div></div></a>
 <div class="newmesnobg box_shadow_left" style="padding-right:0px;padding-bottom:1px;">{videos}<div class="clear"></div>
 </div>[/videos]
 [notes]<a href="/notes/{user-id}" onClick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle box_shadow">Заметки <span>{notes-num}</span><div class="icon_notes" onMouseOver="myhtml.title('10', '<b>Показать все заметки</b>', 'fine_tooltip_')" id="fine_tooltip_10"></div></div></a>
...
<br>
 ...
 [privacy-info][sp]<div class="flpodtext">Семейное положение:</div> <div class="flpodinfo">{sp} </div>[/sp][/privacy-info]
   <div class="flpodtext">[xfgiven_seek]Познакомлюсь:[/xfgiven_seek]</div>
 ...
 [friends]<a href="/friends/{user-id}" onClick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle box_shadow">Друзья: <span>{friends-num}</span><div class="icon_friend" onMouseOver="myhtml.title('1', '<b>Показать всех друзей</b>', 'fine_tooltip_')" id="fine_tooltip_1"></div></div></a><div class="box_shadow_base" style="padding:0px;padding-top:10px;">{friends}<div class="clear"></div></div>[/friends]
 [albums]<a href="/albums/{user-id}" onClick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle box_shadow">Альбомы: <span>{albums-num}</span><div class="icon_albums" onMouseOver="myhtml.title('2', '<b>Показать все альбомы</b>', 'fine_tooltip_')" id="fine_tooltip_2"></div></div></a><div class="box_shadow_base" style="float:right">{albums}</div><div class="clear"></div>[/albums]
 [audios]<div id="jquery_jplayer"></div><input type="hidden" id="teck_id" value="1" /><a href="/audio{user-id}" onClick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle box_shadow">{audios-num}<div class="icon_music" onMouseOver="myhtml.title('3', '<b>Показать все песни</b>', 'fine_tooltip_')" id="fine_tooltip_3"></div></div></a><div class="box_shadow_base">{audios}</div><div class="clear"></div>[/audios]
 <a href="/wall{user-id}" onClick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle box_shadow" style="border-bottom:0px">Стена <span id="wall_rec_num">{wall-rec-num}</span><div class="icon_board" onMouseOver="myhtml.title('4', '<b>Показать все записи</b>', 'fine_tooltip_')" id="fine_tooltip_4"></div></div></a>
